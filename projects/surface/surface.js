...
gui.add(this, 'wave_speed_d').min(0.0).max(0.2).step(0.001).listen();
gui.add(this, 'wave_speed_min_i').min(0.0).max(0.2).step(0.001).listen();
gui.add(this, 'wave_speed_max_i').min(0.0).max(0.2).step(0.001).listen();
